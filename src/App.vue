  ...
  <div class="p-10 md:p-20">
    <div class="container mx-auto grid grid-cols-1 md:grid-cols-2 md:gap-8">
      <section class="w-12/12 md:w-11/12 flex-inline flex-col">
        <!-- <h1 class="font-sans mb-2 p-1 bg-sky-500 text-xs font-semibold tracking-widest text-black uppercase inline-block text-white">Calculadora de treino de corrida</h1> -->
      ...
      <section class="flex justify-center mb-10 md:mb-0">
